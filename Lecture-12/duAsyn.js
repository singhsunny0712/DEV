...
console.log("file saved to : "+ans);
var ans = compressfile(ans)
var ans=await promise;
console.log("file compressed to : "+ans);
var ans = uploadfile(ans);
var ans=await promise;
console.log("file successfully uploaded to : "+ans);
}
helper();